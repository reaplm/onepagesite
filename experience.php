	...
	<div class="container">
		...
		<div class="row mt-3">
			<div class="col-sm-6 card">
				...
				<span class="light-text"> Development of web
				...
				</span> Project Management using Microsoft Team Foundation Server <span
					class="sm-bullet"> &#8226; </span>Creating and maintaining user
					...
					and creating dynamic reports using crystal reports<br /><br />
				<span class="italic">C#, VB, .NET 4.5,
						ASPX, Oracle PL/SQL| Oracle 11g,12c | Visual Studio 2013, Toad for
		...
		<div class="row mt-3">
			...
			<div class="col-sm-5 card">
				...
				<span class="light-text">Writing and maintaining software
					applications using Oracle 10g, Oracle PL/SQL and TOAD<span
					style="color: #f8d650;"> &#8226; </span>Conducting user requirement
					gathering sessions and detailed study to prepare requirement
					...
					administration support to end users<span style="color: #f8d650;">
						&#8226; </span>Modifying online reports using Oracle Reports Builder<span
					style="color: #f8d650;"> &#8226; </span>Oracle Forms development<span
					style="color: #f8d650;"> &#8226; </span>Testing and debugging of PL/SQL
					packages and source code<span style="color: #f8d650;"> &#8226; </span>Producing
					online reports using Reports Builder<span style="color: #f8d650;">
						&#8226; </span>User support and training<br /><br />
				<span class="italic">Oracle Forms, Oracle
						PL/SQL | Oracle 10g, 11g | Forms Builder 10g, Toad, SQL Plus |
						Oracle Reports Builder</span></span><br />
		...
		<div class="row mt-3">
			<div class="col-sm-6 card">
				...
				<span class="light-text">Development of stored
					...
					style="color: #f8d650;">&#8226;</span>Module Testing and Test Case
					Documentation<br />
				<br /> <span class="light-text">Oracle Forms,
							Oracle E-Business Suite, Oracle PL/SQL, Java, JSP | Oracle 11g,
		...
		<div class="row mt-3">
			...
			<div class="col-sm-5 card">
				...
				<span class="light-text">End to End delivery of projects
					using Project Server and SharePoint<span style="color: #f8d650;">
						&#8226; </span>Development of project plans, Gantt charts and project reports<span
					style="color: #f8d650;"> &#8226; </span>Risk management and project
					monitoring<span style="color: #f8d650;"> &#8226; </span>Implementation and
					administration of SharePoint and Project Web Applications<span
					style="color: #f8d650;"> &#8226; </span>Providing support services for
					project web applications and SharePoint
				<br />
				<br /> <span class="italic">Project Web App
						| Microsoft SharePoint | Microsoft Project</span></span><br />
